...
class Settings {
   ...
   public:
    ...
    Parameter<string> configLocation{"./Config/",
    ...
    Parameter<int> camera_distance{
        20,
        {"cameradistance", required_argument, 0, 'R'},
    ...
    Settings() {
        ...
        m_descriptors.push_back(configLocation.getDescriptors());
    ...
    void Parse() {
        ...
        while (1) {
            ...
            switch (c) {
                ...
                case 'X': {
                    texture_threshold = atoi(optarg);
                    break;
                }
                case 'U': {
                    depth_mode = atoi(optarg);
                    break;
                }
                case 'R': {
                    camera_distance = atoi(optarg);
                    break;
                }
                case 'C': {
